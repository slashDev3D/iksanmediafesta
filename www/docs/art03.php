...
<div class="subPage--title">
    <div class="wrap1548">
        <div class="subPage--title-wrap">
            <p class="subPage--title-text1">나만의 도슨트</p>
            <p class="subPage--title-text2">2022. 09. 03 ~ 22. 10. 03<span></span>미륵사지 전체</p>
            ...
            <div class="subPacade--title">
                ...
                <div id="slide01" class="subPacade--slide subPacade--slide1" data-slide-number="01">
                    <p class="subPacade--text2">
                        2022 익산 미륵사지 세계유산 미디어아트 페스타에서는 관람객의 스마트폰에 내장된 GPS를 통해 다양한 위치기반 사운드 콘텐츠를 제공한다. <br>
                        QR코드를 스캔하여 간편하게 도슨트 서비스를 이용할 수 있다. <br>
                        방문객은 관람하는 작품 및 주변 지형·지물에 대한 나레이션 사운드와 주변 환경과 어우러지는 앰비언트 사운드 등을 통해 더욱 다채롭고 몰입감 높은 관람을 즐길 수 있다.
                    </p>
                </div>
            </div>
        </div>
