...
<div class="uniform--container">
    <div class="wrap1548">
        <div class="uniform--wrap">
            ...
            <span></span>
            <p class="now">The Land of Maitreya, the Citizens of One Thousand Years (XR)</p>
        </div>
    </div>
</div>
<div class="subPage--title">
    <div class="wrap1548">
        <div class="subPage--title-wrap">
            <p class="subPage--title-text1">The Land of Maitreya, the Citizens of One Thousand Years (XR)</p>
            <p class="subPage--title-text2">2022. 09. 03 ~ 22. 10. 03<span></span>Media-facade Screen</p>
...
<div class="subPacade--container">
    <div class="wrap1548">
        <div class="subPacade--main-sect">
            <div class="subPacade--main-img"><img src="../common/img/history02_img01.png" alt=""></div>
            <div class="subPacade--main-text">
                ...
                <div class="subPacade--main-text-info">
                  <div>
                    ...
                    <div class="subPacade--main-text-info-row">
                        <p><b>Place</b></p>
                        <p><b>Mireuksa Temple Site Media-façade Screen</b></p>
                    </div>
                    <div class="subPacade--main-text-info-row">
                        <p><b>Time</b></p>
        ...
        <div class="subPacade--sub-sect">
            <div class="subPacade--title">
                ...
                <div id="slide01" class="subPacade--slide subPacade--slide1" data-slide-number="01">
                    ...
                    The extended reality (XR) media performance aims to provide visitors to the Mireuksa Temple Site with opportunities to heal and feel hope.<br><br>
                    A dance performance by two dancers aesthetically expresses the concept “Citizens of a Thousand Years” in the three-dimensional space, or a symbolic earth where the Maitreya Buddha once stood and prayed for King Mu’s love and wishes.</p>
                    <Br><br>
                    <div class="subPacade--main-sect-cont">
                      <div class="contbx"><img src="../common/img/history02_img02.png"></div>
                      <div class="contbx"><img src="../common/img/history02_img03.png"></div>
                </div>
                </div>
            </div>
        </div>
