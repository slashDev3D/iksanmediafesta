        ...
        <div class="foot--row1">
            <div class="foot--row-col1">
                <div class="foot--company foot--company1">
                    <p class="foot--company-text">host / organizer</p>
            ...
            <div class="foot--row-col2">
                <div class="foot--traffic-button"><a href="javascript:GoPage('introduce05')"><p>traffic guidance</p><img src="<?php echo G5_URL; ?>/common/img/foot_green_arrow.png" alt=""></a></div>
        ...
        <div class="foot--row2">
            <div class="foot--row-col3">
                ...
                <div class="foot--row2-text02">
                    ...
                    <span></span>
                    <a href="javascript:GoPage('introduce05')">Getting to Mireuksa Temple Site</a>
                </div>
