...
add_stylesheet('<link rel="stylesheet" href="'.G5_URL.'/common/css/swiper.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_URL.'/common/css/public.css">', 0);

if (defined("_INDEX_")) {
  add_stylesheet('<link rel="stylesheet" href="'.G5_URL.'/common/css/main.css">', 0);
} else {
  add_stylesheet('<link rel="stylesheet" href="'.G5_URL.'/common/css/pacade.css">', 0);
}
